...
- **Le informazioni pratiche di visita non si suppongono mai.** Aperture, orari, modalità di accesso entrano nel testo solo se confermate dall'utente o da una fonte istituzionale recente; la visitabilità di un sito archeologico cambia spesso, e scrivere «visitabile» di un luogo chiuso è l'errore che più danneggia la fiducia del lettore. In dubbio: «lo stato di apertura va verificato presso il Museo/Comune».
